...
function Block6:ctor(angle, min, max)
    BaseBlock.ctor(self, 6, angle, min, max)
...
function Block6:rotation()
    ...
    elseif self.angle == 90 then
        ...
        self.sprite3:setPosition(cc.p(30, 30))
        self.sprite4:setPosition(cc.p(30, 0))
        self.offsetLeft = 0
        self.offsetRight = 0
    elseif self.angle == 180 then
        self.angle = 270
        self.sprite1:setPosition(cc.p(30, 00))
    ...
    elseif self.angle == 270 then
        ...
        self.sprite4:setPosition(cc.p(0, 60))
        self.offsetLeft = 0
        self.offsetRight = 0
    end
